...
// Check if the user is logged in and has admin rights, otherwise redirect to the login page
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true || $_SESSION['userRole'] != 2) { // Assuming '2' is the Admin role ID
...
<head>
    ...
    <title>Admin Dashboard | Nova View Hotel</title>
...
<body>
    ...
    <div class="profile-container">
        <div class="profile-box">
            <h2><?php echo htmlspecialchars($username); ?> - Admin Dashboard</h2>
            <div class="user-info">
        ...
        <div class="button-bar">
            ...
            <a class="btn" href="adminCheckInOut.php">Check-in/Checkout</a>
            <a class="btn" href="adminHousekeeping.php">Housekeeping</a>
            <a class="btn" href="roomManagement.php">Add/Modify Room Info</a>
        </div>
    </div>
